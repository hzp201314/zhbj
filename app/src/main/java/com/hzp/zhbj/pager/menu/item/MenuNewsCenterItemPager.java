package com.hzp.zhbj.pager.menu.item;
...
import com.hzp.zhbj.activity.news.NewsDetailActivity;
import com.hzp.zhbj.base.BaseMenupager;
import com.hzp.zhbj.bean.NewBean;
import com.hzp.zhbj.bean.NewBean.News;
import com.hzp.zhbj.net.NetUrl;
import com.hzp.zhbj.ui.PullToRefreshListView;
import com.hzp.zhbj.ui.PullToRefreshListView.OnReFreshListener;

import com.hzp.zhbj.ui.RollViewPager;
...
public class MenuNewsCenterItemPager extends BaseMenupager {
	...
	private void getData(final String url,final boolean isLoadMore) {
		...
		if (!TextUtils.isEmpty(url)) {
			...
			Toast.makeText(activity, "没有最新数据了", 0).show();
			//取消刷新
			mListView.finish();
		}
	}
	...
	/**
	 * 获取数据展示数据
	 *isLoadMore : 标示是否是加载更多,true：加载更多，false:下拉刷新
	 * 2016-11-4 下午4:41:14
	 */
			...
			view.setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_DOWN:
						System.out.println("viewpager中的veiw的action_down");
						//不发送延迟消息，不进行自动滚动
